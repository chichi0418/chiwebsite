...
function saveGameHistory($game) {
    ...
    try {
        ...
        // // 插入遊戲歷史到 game_history 表
        // $insertQuery = "INSERT INTO game_history (username, round, player_hand, dealer_hand, result, bet, remaining_chips) 
        //                 VALUES (:user_id, :round, :player_hand, :dealer_hand, :result, :bet, :remaining_chips)";
        // $insertStmt = $pdo->prepare($insertQuery);
        // $insertStmt->execute([
        //     ':user_id' => $user_id,
        //     ':round' => $game['round'],
        //     ':player_hand' => json_encode($game['playerHand']),
        //     ':dealer_hand' => json_encode($game['dealerHand']),
        //     ':result' => $game['result'],
        //     ':bet' => $game['bet'],
        //     ':remaining_chips' => $game['remainingChips']
        // ]); 
    } catch (PDOException $e) {
        // 處理資料庫錯誤
